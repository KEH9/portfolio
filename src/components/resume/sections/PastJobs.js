  ...
  return (
    <div className="past-jobs">
      ...
      <div className="paragraph">
        ...
        <h3>2007 / 2009</h3>
        <div>
          <span className="job">Center for Informational and Finance Technologies (CIFT)</span>
          <span className="position"> Position: Project manager</span>
      ...
      <div className="paragraph">
        ...
        <h3>2006 / 2007</h3>
        <div>
          <span className="job">The Network of Pharmacies «Atoll-Pharm» /
      ...
      <div className="paragraph">
        <h3>2002 / 2006</h3>
        <div>
          <span className="job">Finance-Budget department of City Ekaterinburg</span>
      ...
      <div className="paragraph">
        ...
        <div className="last">
          <span className="job">PG «UralInvestEnergo»</span>
